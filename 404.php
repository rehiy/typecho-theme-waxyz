    ...
    <div class="container">
        <div class="row" id="404">
            ...
            <p class="text404 btn404">
                <!--a href="javascript:history.go(-1)" class="btn btn-default"><?php _e('返回上一页'); ?></a-->
                <a href="<?php $this->options->siteUrl(); ?>" class="btn btn-default"><?php _e('返回首页'); ?>（<scan id="time"></scan>）</a>
            </p>
        </div>
