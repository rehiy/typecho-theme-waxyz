  ...
  <?php if (!empty($this->options->sidebarBlock) && in_array('ShowAbouts', $this->options->sidebarBlock)) : ?>
    <div class="widget">
      ...
      <?php if (!empty($this->options->cardBg)) : ?>
        <div class="card-bg" style="background-image: url(<?php $this->options->cardBg(); ?>);
        <?php if (in_array('ShowSearch', $this->options->sidebarBlock)) {
          echo 'top: 168px;';
        } ?>"></div>
      <?php endif; ?>
      <div class="card">
      ...
      <div class="category">
        ...
        <ul class="menu-list">
          <?php while ($category->next()) : ?>
            ...
            <?php } else {
              if ($lestLevels < $category->levels && $lestLevels === 0) {
                echo '<ul>';
              } ?>
              <li>
                <a href="<?php $category->permalink(); ?>" title="<?php $category->name(); ?>">
